 ...
 */
    ...
    $GLOBALS['TL_LANG']['MSC']['C4G_BE_INFO']['APICHECK']['WARNING']        = 'Tämä työkalu voi vahingoittaa .htaccess-tiedostoa API-hakemistossa ("con4gis_core/api/"), jos olet editoinut sitä jo manuaalisesti. Kannattaa tehdä varmuuskopio tiedostolle ennen kuin suoritat tämän työkalun.';
