                    ...
                    $(content.dialogbuttons).each(function (index, value) {
                        ...
                        dialogoptions.buttons.push({
                            cssClass: aClass, accesskey: aAccesskey, text: value.text, click: function () {
                                ...
                                if (value['onclick'] == 'printButtonAction') {
                                    //@todo hier falsch, weil der AJAX-Call schon raus ist! Muss eigentlich den Call ersetzen!
                                    location.href = '/con4gis/api/c4g_brick_ajax/' + internalId + '/print:8?id=0';
                                }
